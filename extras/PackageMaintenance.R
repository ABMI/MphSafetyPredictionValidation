...
OhdsiRTools::checkUsagePackage("SkeletonPredictionValidationStudy")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/SkeletonPredictionValidationStudy.pdf")
shell("R CMD Rd2pdf ./ --output=extras/SkeletonPredictionValidationStudy.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("SkeletonPredictionValidationStudy")
