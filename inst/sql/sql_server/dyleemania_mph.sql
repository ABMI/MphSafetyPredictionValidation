...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4333677,35610112,4153292,439256,440078,4150985)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4333677,35610112,4153292,439256,440078,4150985)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (21604422,745466,21604555,751246,705103,21604431,740275,21604417,600000004)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (21604422,745466,21604555,751246,705103,21604431,740275,21604417,600000004)
  and c.invalid_reason is null
