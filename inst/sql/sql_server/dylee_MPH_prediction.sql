...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4047120,438409)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4047120,438409)
  and c.invalid_reason is null
...
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (750982)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (750982)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (742185,750982,21600398,21604741,21604762)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (742185,750982,21600398,21604741,21604762)
  and c.invalid_reason is null
...
case when datediff(dd, start_date, end_date)/365.25<1 then end_date
	when datediff(dd, start_date, end_date)/365.25>=1 then dateadd(day, 365, start_date) end as end_date 
	into #final_cohort1
	from #final_cohort
	;
...
TRUNCATE TABLE #final_cohort1;
DROP TABLE #final_cohort1;
