...
#
# This file is part of MphSafetyPredictionValidation
#
...
createCohorts <- function(
  ...
  cohortDefinitionSet <- CohortGenerator::getCohortDefinitionSet(packageName = "MphSafetyPredictionValidation",
...
addCohortNames <- function(data, IdColumnName = "cohortId", nameColumnName = "cohortName") {
  pathToCsv <- system.file("Cohorts.csv", package = "MphSafetyPredictionValidation")
